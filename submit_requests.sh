...
CLIENT_SECRET=iaDMVOKEGssvW5XRaaqZN4EO3lkvdRu6
...
curl -X POST http://localhost:9099/v1/reviews -H 'Content-Type: application/json' -H "$AUTH_HEADER" -d '{"menuId": 1, "comment": "Comment", "rate": 5}'
printf "\n\n"
curl -X POST http://localhost:9099/v1/reviews -H 'Content-Type: application/json' -H "$AUTH_HEADER" -d '{"menuId": 4, "comment": "Comment", "rate": 3}'
printf "\n\n"
curl -X POST http://localhost:9099/v1/reviews -H 'Content-Type: application/json' -H "$AUTH_HEADER" -d '{"menuId": 5, "comment": "Comment", "rate": 2}'
printf "\n\n"
